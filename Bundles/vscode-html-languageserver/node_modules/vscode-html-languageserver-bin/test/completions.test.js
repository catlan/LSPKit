...
function assertCompletion(completions, expected, document, offset) {
...
function testCompletionFor(value, expected, uri, workspaceFolders) {
    if (uri === void 0) { uri = testUri; }
    ...
    var document = vscode_languageserver_types_1.TextDocument.create(uri, 'html', 0, value);
...
suite('HTML Path Completion', function () {
    ...
    var fixtureRoot = path.resolve(__dirname, 'pathCompletionFixtures');
    var fixtureWorkspace = { name: 'fixture', uri: vscode_uri_1.default.file(fixtureRoot).toString() };
    var indexHtmlUri = vscode_uri_1.default.file(path.resolve(fixtureRoot, 'index.html')).toString();
    var aboutHtmlUri = vscode_uri_1.default.file(path.resolve(fixtureRoot, 'about/about.html')).toString();
    test('Basics - Correct label/kind/result/command', function () {
    ...
    test('Basics - Single Quote', function () {
        testCompletionFor("<script src='./|'>", {
            items: [
                { label: 'about/', kind: vscode_languageserver_types_1.CompletionItemKind.Folder, resultText: "<script src='./about/'>", command: triggerSuggestCommand },
                { label: 'index.html', kind: vscode_languageserver_types_1.CompletionItemKind.File, resultText: "<script src='./index.html'>" },
    ...
    test('No completion for remote paths', function () {
    ...
    test('Empty Path Value', function () {
        // document: index.html
        testCompletionFor('<script src="|">', {
            items: [
                { label: 'about/', resultText: '<script src="about/">' },
    ...
    test('No leading dot or slash', function () {
        // document: index.html
    ...
    test('Trigger completion in middle of path', function () {
        // document: index.html
    ...
    test('Trigger completion in middle of path and with whitespaces', function () {
